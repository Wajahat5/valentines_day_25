...
const cards = [
  { 
    ...
    image: onBike, 
    message: "Look up at the sky, my love. The same moon and stars shine over us both, connecting our hearts across the distance. You are never alone—I am always with you."
  },
  { 
  ...
  { 
    ...
    image: onThighs, 
    message: "Breathe in, breathe out. Imagine my arms around you, soothing away all your worries. You’ve got this, and I believe in you, always."
  },
  { 
  ...
  return (
    <div className="container">
      ...
      >
        ...
        <p>
        No matter how far apart we are, our love remains unshaken—woven with trust, strengthened by time, and bound by the promise of forever.
        </p>
        <p>
        Miles may separate us, but my love for you knows no bounds. Every heartbeat whispers your name, and every thought holds you close.
        </p>
        <p>
          Flip these cards to reveal little pieces of my love, made just for
          you. 💌
        </p>
      </motion.div>
